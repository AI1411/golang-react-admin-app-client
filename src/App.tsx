...
export const App = () => {
    ...
    const getTodos = () => {
        axios.get("http://localhost:8084/todos").then(res => {
            setTodoCount(res.data.data.length);
        }).catch(err => {
            console.log(err);
        });
    };
                                ...
                                <a className="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                   href="#">
                                    <div className="p-5">
                                        ...
                                        <div className="ml-2 w-full flex-1">
                                            <div>
                                                <div className="mt-3 text-3xl font-bold leading-8">{todoCount}</div>

                                                <div className="mt-1 text-base text-gray-600">All Todos</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
